...
class BettingAdapter(private val players: List<Bettingaverage>) : RecyclerView.Adapter<BettingAdapter.PlayerViewHolder>() { // Use BettingAdapter instead of Bettingaverage
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlayerViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_bestaverage, parent, false)
